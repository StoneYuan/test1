...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 10.0) {
        ...
        UNAuthorizationOptions myTypes = UNAuthorizationOptionBadge|UNAuthorizationOptionAlert|UNAuthorizationOptionSound;
        [[UNUserNotificationCenter alloc]requestAuthorizationWithOptions:myTypes completionHandler:^(BOOL granted, NSError * _Nullable error) {
    ...
    [BPush registerChannel:launchOptions apiKey:@"ONI14Mty33VpiKq2wE9j8hWC"pushMode:BPushModeDevelopment withFirstAction:@"打开" withSecondAction:@"关闭" withCategory:@"test" useBehaviorTextInput:YES isDebug:YES];
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo fetchCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler
{
    ...
    if (application.applicationState == UIApplicationStateInactive && !isBackGroundActivateApplication)
    {
        ...
        skipCtr.useInfo = userInfo;
        // 根视图是nav 用push 方式跳转
        [self.viewController.navigationController pushViewController:skipCtr animated:YES];
        NSLog(@"applacation is unactive   userInfo ===== %@",userInfo);
        /*
